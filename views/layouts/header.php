...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <div class="container">
        <a class="navbar-brand" href="<?= htmlspecialchars(Url::to('/')) ?>">Fundación Crece Contigo</a>
                ...
                <?php if ($user): ?>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li><a class="dropdown-item" href="<?= htmlspecialchars(Url::to('logout')) ?>">Cerrar sesión</a></li>
                        </ul>
                    </li>
                <?php else: ?>
                    <li class="nav-item"><a class="nav-link" href="<?= htmlspecialchars(Url::to('login')) ?>">Iniciar sesión</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?= htmlspecialchars(Url::to('register')) ?>">Registrarse</a></li>
                <?php endif; ?>
            </ul>
        </div>
    </div>
